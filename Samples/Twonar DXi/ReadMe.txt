...
Twonar.h, Twonar.cpp:
    CTwonar, the DirectX plug-in object.

TwonarPropPage.h, TwonarPropPage.cpp:
    CTwonarPropPage, an MFC CDialog class that implements
...
TwonarApp.h
TwonarApp.cpp:
    CTwonarApp, an MFC CWinApp derived object.
...
StdAfx.h, StdAfx.cpp
    ...
    named MFCDelay.pch and a precompiled types file named StdAfx.obj.
