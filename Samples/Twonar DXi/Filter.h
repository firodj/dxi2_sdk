...
private:
	...
	long			m_lRefCount;					// refcount for this object
...
public:
	...
	int			GetOutputPinCount() const { return m_cPinOutput; }
...
private:
	...
	CGenericList<CFilterOutputPin>	m_listPinOutput;
	int										m_cPinOutput;
