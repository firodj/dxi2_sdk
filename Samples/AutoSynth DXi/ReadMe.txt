...
AutoSynth.h, AutoSynth.cpp:
    CAutoSynth, the DirectX plug-in object.

AutoSynthPropPage.h, AutoSynthPropPage.cpp:
    CAutoSynthPropPage, an MFC CDialog class that implements
    the plug-in's property page.
...
AutoSynthApp.h
AutoSynthApp.cpp:
    CAutoSynthApp, an MFC CWinApp derived object.
...
StdAfx.h, StdAfx.cpp
    ...
    named AutoSynth.pch and a precompiled types file named StdAfx.obj.
