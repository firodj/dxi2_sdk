...
AutoClip.h, AutoClip.cpp:
    CAutoClip, the DirectX plug-in object.

AutoClipPropPage.h, AutoClipPropPage.cpp:
    CAutoClipPropPage, an MFC CDialog class that implements
...
AutoClipApp.h
AutoClipApp.cpp:
    CAutoClipApp, an MFC CWinApp derived object.
...
StdAfx.h, StdAfx.cpp
    ...
    named AutoClip.pch and a precompiled types file named StdAfx.obj.
