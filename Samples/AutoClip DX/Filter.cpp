...
const GUID CLSID_Filter =
	{ 0x521f0204, 0x7f06, 0x430f, { 0xb9, 0x85, 0x2e, 0x07, 0x19, 0x7f, 0x65, 0x4e } };

const GUID CLSID_FilterPropPage =
	{ 0x6677c6d6, 0x728d, 0x4781, { 0xbc, 0x1c, 0x2b, 0xd0, 0x21, 0x91, 0x4c, 0x16 } };
...
static AMOVIESETUP_FILTER sudFilter =
{
    ...
    L"AutoClip Plug-In",         // Filter's name
...
CFactoryTemplate g_Templates[ 2 ] =
{
    ...
    , &sudFilter }
	 ,
	 { L"AutoClip Properties"
	 , &CLSID_FilterPropPage
	 , CAutoClipPropPage::CreateInstance
	 , NULL
	 , NULL }
};
